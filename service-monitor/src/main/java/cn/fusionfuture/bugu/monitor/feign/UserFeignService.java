...
public interface UserFeignService {
    ...
    @GetMapping(value = "/user/achievement/monitor-plan/plan-count/{uid}")
    ...
    @GetMapping(value = "/user/achievement/monitor-plan/success-count/{uid}")
    ...
    @GetMapping(value = "/user/achievement/monitor-plan/participate-count/{uid}")
