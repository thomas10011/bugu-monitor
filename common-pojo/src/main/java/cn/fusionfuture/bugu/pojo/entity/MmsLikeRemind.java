...
@ApiModel(value="MmsLikeRemind对象", description="")
public class MmsLikeRemind implements Serializable {

    private static final long serialVersionUID = 1781949930503367444L;
