...
@ApiModel(value="MmsEnrollRemind对象", description="")
public class MmsEnrollRemind implements Serializable {

    private static final long serialVersionUID = 5254239176666965504L;
