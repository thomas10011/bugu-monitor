...
@ApiModel(value="MmsCommentRemind对象", description="")
public class MmsCommentRemind implements Serializable {

    private static final long serialVersionUID = -7324470099720389053L;
